...
export default defineConfig({
  ...
  lint: {
    ...
    ignorePatterns: [
      ...
      ".astro/",
      // Vendored shadcn/ui primitives: generated by the shadcn CLI and updated
      // by re-running it, so local fixes are lost on the next add. Lint our own
      // compositions instead (packages/ui/src, apps/**).
